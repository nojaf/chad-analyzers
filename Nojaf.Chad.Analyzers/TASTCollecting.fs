module Nojaf.Chad.Analyzers.TASTCollecting

// Stolen from https://github.com/G-Research/fsharp-analyzers/blob/main/src/FSharp.Analyzers/TASTCollecting.fs

open FSharp.Compiler.Symbols
open FSharp.Compiler.Text
open FSharp.Compiler.Symbols.FSharpExprPatterns

type Handler = range -> FSharpType -> unit
...
let rec visitExpr (handler : Handler) (e : FSharpExpr) =
    ...
    | NewRecord (recordType, _argExprs) -> handler e.Range recordType
